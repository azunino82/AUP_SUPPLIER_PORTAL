sap.ui.define([
	...
	return Controller.extend("it.aupsup.schedulingagreement.controller.BaseController", {
		getRouter: function () {
		...
		getGlobalCustomizing: function () {
			...
			var url = "/backend/CustomizingManagement/GetCustomizingGlobalValues?I_APPID=SCHED_AGR";
			var that = this;
			this.ajaxGet(url, function (oData) {
				if (oData && oData.results && oData.results.length > 0) {
