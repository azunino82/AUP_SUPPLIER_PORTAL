sap.ui.define([
	...
	return BaseController.extend("it.aupsup.searchHU.AUPSUP_HTML5_SEARCH_HU.controller.Worklist", {
		...
		handleMatnr: function () {
			...
			if (!that.oSearchMatnrDialog) {
				that.oSearchMatnrDialog = sap.ui.xmlfragment("it.aupsup.searchHU.AUPSUP_HTML5_SEARCH_HU.fragments.SearchMatnr", that);
