sap.ui.define([
    "it/aupsup/logsordsched/controller/BaseController",
    "sap/ui/model/Filter",
    ...
    "sap/m/MessageToast",
    "sap/ui/model/Sorter",
    "it/aupsup/logsordsched/js/Date",
    "it/aupsup/logsordsched/js/TimestampFormatter",
    "it/aupsup/logsordsched/js/formatter",
    ...
    return BaseController.extend("it.aupsup.logsordsched.controller.Worklist", {
        ...
        handleMatnr: function () {
            ...
            if (!that.oSearchMatnrDialog) {
                that.oSearchMatnrDialog = sap.ui.xmlfragment("it.aupsup.logsordsched.fragments.SearchMatnr", that);
		...
		handleTextPopoverPress: function (oEvent) {
			...
			if (!this._oPopover) {
				Fragment.load({
					name: "it.aupsup.logsordsched.fragments.TextPopOver",
					controller: this
